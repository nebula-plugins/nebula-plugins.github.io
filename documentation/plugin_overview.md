...
The goal of the [gradle-dependency-lock-plugin]({{ site.baseurl }}/plugins/gradle_dependency_lock.html) is to ensure builds are repeatable over time, by locking the complete transitive dependency graph into a single source file. This particular plugin is useful for:
...
The [nebula-ospackage-plugin page]({{ site.baseurl }}/plugins/nebula_ospackage.html) is an opinionated implementation of the gradle-ospackage-plugin. With the nebula-ospackage-plugin, you can easily package your Gradle application into a RPM or Debian that will setup a daemon process on Tomcat.  

Check out the [nebula-ospackage-plugin page]({{ site.baseurl }}/plugins/nebula_ospackage.html) for details on how to use it.
...
Check out the [gradle-git-scm-plugin page]({{ site.baseurl }}/plugins/gradle_git_scm.html) for details on how to use it.
...
Check out the [gradle-stash-plugin page]({{ site.baseurl }}/plugins/gradle-stash.html) for details on how to use it.
...
Check out the [nebula-bintray-plugin page]({{ site.baseurl }}/plugins/nebula_bintray.html) for details on how to use it.
...
- applies the [gradle-info-plugin]( {{ site.baseurl }}/plugins/gradle_info.html)
- applies the [gradle-contacts-plugin]( {{ site.baseurl }}/plugins/gradle_contacts.html)

Check out the [nebula-project-plugin page]({{ site.baseurl }}/plugins/nebula_project.html) for details on how to use it.

### gradle-contacts-plugin
A feature provided by Maven that is missing from Gradle is the `<developers/>` section, which denotes the contact information for the owners of the project. The purpose of the  [gradle-contacts-plugin]({{ site.baseurl }}/plugins/gradle_contacts.html) is to provide comparable features to Gradle.  
...
If you are building a multi-module project and would like to publish a single Javadoc site for all modules, we recommend using the [gradle-aggregate-javadocs-plugin]({{ site.baseurl }}/plugins/gradle_aggregate_javadocs.html).

Check out the [gradle-aggregate-javadocs-plugin page]({{ site.baseurl }}/plugins/gradle_aggregate_javadocs.html) for details on how to use it.
...
Check out the [gradle-extra-configurations-plugin page]({{ site.baseurl }}/plugins/gradle_extra_configurations.html) for details on how to use it.
...
An opinionated plugin that wraps the [clojuresque](https://bitbucket.org/clojuresque/clojuresque) gradle plugin, removing the [Clojars](https://clojars.org/)w logic.

Check out the [nebula-clojure-plugin page]({{ site.baseurl }}/plugins/nebula_clojure.html) for details on how to use it.
